...
<?php 
$id=$_GET['id'];
$query2 = "SELECT * FROM admin WHERE id_admin='$id'";
      ...
      ?>  
			<div class="field">
			  ...
			  <div class="control has-icons-left has-icons-right">
			    <input class="input is-success" type="text" placeholder="Username" name="username" value="<?php echo $r['username']; ?>" readonly="">
...
<?php } ?>
			...
			<div class="field">
			  <p class="control">
			  	<div class="buttons">
			  		<button class="button is-success" name="ubahpass">
				      Ubah
				    </button>
