...
<aside class="menu">
  ...
  <ul class="menu-list">
    ...
    <li>
      ...
      <ul>
        <li><a href="members.php" class="is-active" >Members</a></li>
  ...
  <div class="tile is-parent">
    ...
    <tr>
     ...
     <td><?php echo $r['status_admin']; ?></td>

    
     <td><div class="buttons">
         <a href="ubahpass.php?id=<?php echo $r['id_admin'] ?>" class="button is-warning">Ubah Password</a>
         <a href="controller/hapusmembers.php?id=<?php echo $r["id_admin"] ?>" class="button is-danger">Hapus</a>
      </div></td>
